...
object_detect_t::~object_detect_t( )
{
}

extern QImage cvMatToQImage( cv::Mat const & frame );

void object_detect_t::detect( )
{
...
void object_detect_t::set_max_v( size_t max_v_ )
{
   this->max_v_ = max_v_;
}

size_t object_detect_t::get_max_v( ) const
{
   return max_v_;
}

void object_detect_t::set_min_v( size_t min_v_ )
{
   this->min_v_ = min_v_;
}

size_t object_detect_t::get_min_v( ) const
{
   return min_v_;
}

void object_detect_t::set_max_s( size_t max_s_ )
{
   this->max_s_ = max_s_;
}

size_t object_detect_t::get_max_s( ) const
{
   return max_s_;
}

void object_detect_t::set_min_s( size_t min_s_ )
{
   this->min_s_ = min_s_;
}

size_t object_detect_t::get_min_s( ) const
{
   return min_s_;
}

void object_detect_t::set_max_h( size_t max_h_ )
{
   this->max_h_ = max_h_;
}

size_t object_detect_t::get_max_h( ) const
{
   return max_h_;
}

void object_detect_t::set_min_h( size_t min_h_ )
{
   this->min_h_ = min_h_;
}

size_t object_detect_t::get_min_h( ) const
{
   return min_h_;
}

void object_detect_t::set_min_obj_size( size_t min_obj_size_ )
{
   this->min_obj_size_ = min_obj_size_;
}

size_t object_detect_t::get_min_obj_size( ) const
{
   return  min_obj_size_;
}

void object_detect_t::set_max_obj_size( size_t max_obj_size_ )
{
   this->max_obj_size_ = max_obj_size_;
}

size_t object_detect_t::get_max_obj_size( ) const
{
   return  max_obj_size_;
}

Q_SLOT void object_detect_t::stop_loop()
{
   is_working_ = 0;
}


Q_SLOT void object_detect_t::set_brightness_hardware( double hbrightness )
{
   camera_.set_brightness( hbrightness );
}

Q_SLOT void object_detect_t::set_contrast_hardware( double hcontrast )
{
   camera_.set_contrast( hcontrast );
}

Q_SLOT void object_detect_t::set_saturation_hardware( double hsaturation )
{
   camera_.set_saturation( hsaturation );
}

Q_SLOT void object_detect_t::set_hue_hardware( double hhue )
{
   camera_.set_hue( hhue );
}

Q_SLOT void object_detect_t::set_gain_hardware( double hgain )
{
   camera_.set_gain( hgain );
}

Q_SLOT void object_detect_t::set_exposure_hardware( double hexposure)
{
  camera_.set_exposure( hexposure );
}

Q_SLOT void object_detect_t::set_brightness_software( double hbrightness )
{
   camera_.set_brightness_s( hbrightness );
}

Q_SLOT void object_detect_t::set_contrast_software( double hcontrast )
{
   camera_.set_contrast_s( hcontrast );
}

Q_SLOT void object_detect_t::set_min_h( int min_h )
{
   set_min_h((size_t)min_h);
}

Q_SLOT void object_detect_t::set_max_h( int max_h )
{
   set_max_h((size_t)max_h);
}

Q_SLOT void object_detect_t::set_min_v( int min_v )
{
   set_min_v((size_t)min_v);
}

Q_SLOT void object_detect_t::set_max_v( int max_v )
{
   set_max_v((size_t)max_v);
}

Q_SLOT void object_detect_t::set_min_s( int min_s )
{
   set_min_s((size_t)min_s);
}

Q_SLOT void object_detect_t::set_max_s( int max_s )
{
   set_max_s((size_t)max_s);
}

Q_SLOT void object_detect_t::set_min_size( int min_size )
{
   set_min_obj_size((size_t)min_size);
}

Q_SLOT void object_detect_t::set_max_size( int max_size )
{
